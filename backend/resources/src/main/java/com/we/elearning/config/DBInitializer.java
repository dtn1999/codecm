...
public class DBInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Template nuxt = Template.builder()
                ...
                .githubRepoUrl("https://github.com/nuxt/starter.git")
                .build();
        ...
        Template vueJs = Template.builder()
                ...
                .githubRepoUrl("https://github.com/villeristi/vue.js-starter-template.git")
                .build();
        ...
        Template nextJSPayment = Template.builder()
                ...
                .githubRepoUrl("https://github.com/vercel/nextjs-subscription-payments.git")
                .build();
        ...
        Template nextJsLanding = Template.builder()
                ...
                .githubRepoUrl("https://github.com/ixartz/Next-JS-Landing-Page-Starter-Template.git")
                .build();
