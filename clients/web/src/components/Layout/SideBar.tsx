            ...
            <div className="space-y-1 pb-5 lg:px-1 xl:px-0">
              {section.children.map((child, index) => (
                <Link
                  key={index}
                  className={cn(
                    "group flex items-center rounded-md px-3 py-2 text-xs font-medium text-gray-600 hover:bg-gray-200/40 hover:text-gray-800 dark:hover:bg-gray-700/30 dark:hover:text-gray-200 md:text-sm lg:justify-center lg:p-2 xl:justify-start xl:px-3 xl:py-2",
                    {
                      "bg-gray-200/40 text-gray-800 dark:bg-gray-700/30 dark:text-gray-200":
